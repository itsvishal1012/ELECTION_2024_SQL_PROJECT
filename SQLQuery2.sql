-- Total number of seats in constituency
SELECT
DISTINCT COUNT(Parliament_constituency) AS Total_Seats
from constituencywise_results

-- Total Number oof seats available in each state for election
SELECT
s.state AS STATE_NAME,
COUNT(cr.parliament_constituency) AS Total_Aeats
from 
...
-- ADD NEW COLUMN IN PARTYWISE TABLE TO GROUP THEM AS NDA ALLAINCE OR OTHERS 
...
WHERE s.State = 'Uttar Pradesh' AND cr.Constituency_Name = 'AGRA';
...
-- For the state, what are the total number of seats, total number of candidates, total number of parties, total votes (including EVM and postal), and the breakdown of EVM and postal votes?
SELECT 
